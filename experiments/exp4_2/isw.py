...
def mrcl_isw_rln(inputs, n_layers=6, hidden_units_per_layer=300, seed=None):
    """
...
def mrcl_isw(n_layers_rln=6, n_layers_tln=2, hidden_units_per_layer=300, one_hot_depth=10, seed=0):
    """
