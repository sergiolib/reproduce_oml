...
from experiments.exp4_2.omniglot_model import mrcl_omniglot, get_data_by_classes, \
    partition_into_disjoint, pretrain_classification_mrcl, sample_trajectory, sample_random, sample_random_10_classes, evaluate_classification_mrcl, compute_loss
...
rln_saved = tf.keras.models.load_model("saved_models/rln_pretraining_mrcl_1900_omniglot.tf")
